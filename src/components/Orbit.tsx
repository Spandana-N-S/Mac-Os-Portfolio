...
// --- Type Definitions ---
type IconType = 'html' | 'css' | 'javascript' | 'react' | 'node' | 'tailwind' | 'python' | 'typescript' | 'vue' | 'next' | 'sql' | 'mongodb' | 'postgresql' | 'docker' | 'kubernetes' | 'aws' | 'git' | 'fastapi' | 'tensorflow' | 'pytorch' | 'code';

type GlowColor = 'cyan' | 'purple' | 'blue' | 'green' | 'yellow' | 'pink';
...
const iconComponents: Record<IconType, { component: () => React.JSX.Element; color: string }> = {
  ...
  mongodb: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#47A248"/>
      </svg>
    ),
    color: '#47A248'
  },
  postgresql: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#336791"/>
      </svg>
    ),
    color: '#336791'
  },
  docker: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#2496ED"/>
      </svg>
    ),
    color: '#2496ED'
  },
  kubernetes: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#326CE5"/>
      </svg>
    ),
    color: '#326CE5'
  },
  aws: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#FF9900"/>
      </svg>
    ),
    color: '#FF9900'
  },
  git: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#F05032"/>
      </svg>
    ),
    color: '#F05032'
  },
  ...
  tensorflow: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#FF6F00"/>
      </svg>
    ),
    color: '#FF6F00'
  },
  pytorch: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12-5.373 12-12 12zm-1.49-5.914l4.134-9.772h1.83l-5.344 12.31h-1.48l-1.47-3.416h-4.02l2.39 5.59h1.78l.006.006.006-.006h.004zm-2.85-6.62l-.81 1.87h2.68l-.81-1.87h-1.06z" fill="#EE4C2C"/>
      </svg>
    ),
    color: '#EE4C2C'
  },
...
export default function OrbitingSkills() {
  ...
  const orbitConfigs: Array<{ radius: number; glowColor: GlowColor; delay: number }> = [
    ...
    { radius: 260, glowColor: 'blue', delay: 3 }
  ];
