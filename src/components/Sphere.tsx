import SphereImageGrid, { ImageData } from "./ImageSphere";
...
for (let i = 0; i < 30; i++) { // Reduced number of images for better performance
...
const CONFIG: SphereConfig = {
  containerSize: 500,          // Reduced container size for better fit in Achievements page
  sphereRadius: 150,           // Reduced virtual sphere radius
  ...
  baseImageScale: 0.12,        // Base image size
